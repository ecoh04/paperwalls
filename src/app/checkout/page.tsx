    ...
    <PageContainer>
      ...
      <div className="mt-8 grid gap-8 lg:grid-cols-3">
        ...
        <div className="order-1 lg:order-2 lg:col-span-1">
          <div className="rounded-pw-card border border-[rgba(26,23,20,0.1)] bg-pw-surface p-5 shadow-pw-sm">
            <h2 className="text-lg font-semibold text-pw-ink">Your order</h2>
            <ul className="mt-4 space-y-3">
              {items.map((item) => (
                <li key={item.id} className="flex gap-3 border-b border-[rgba(26,23,20,0.08)] pb-3 last:border-0">
                  {item.type === "sample_pack" ? (
                    <>
                      <div className="flex h-16 w-16 flex-shrink-0 items-center justify-center rounded border border-[rgba(26,23,20,0.1)] bg-pw-bg">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="text-xs text-pw-muted-light">All 4 materials · Qty: {item.quantity}</p>
                      </div>
                    </>
                  ) : (
                    <>
                      <div className="h-16 w-16 flex-shrink-0 overflow-hidden rounded border border-[rgba(26,23,20,0.1)] bg-pw-bg">
                        <img
                  ...
                  <p className="text-sm font-semibold text-pw-ink">{formatZar(item.subtotalCents)}</p>
                </li>
              ))}
            </ul>
            <p className="mt-4 text-xs text-pw-muted-light">
              Shipping is free. Total includes wallpaper and installation options selected.
            </p>
          </div>
        </div>
      </div>
