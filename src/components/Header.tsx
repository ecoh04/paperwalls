  ...
  return (
    <header className="sticky top-9 z-40 border-b border-pw-stone bg-pw-bg/95 backdrop-blur supports-[backdrop-filter]:bg-pw-bg/85">
      ...
      */}
      ...
      {/* Mobile menu overlay — fills the viewport below the sticky stack.
          Self-contained as a separate fixed element so the sticky-parent
          stacking context doesn't trap it. */}
      <div
        id="mobile-menu"
        aria-hidden={!open}
        className={[
          "fixed inset-x-0 top-[5.75rem] bottom-0 z-40 overflow-y-auto bg-pw-bg transition-opacity duration-200 md:hidden",
